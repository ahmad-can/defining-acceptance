...
) -> HTTPValidationError | list[ArtefactBuildResponse] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | list[ArtefactBuildResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | list[ArtefactBuildResponse]
    """
