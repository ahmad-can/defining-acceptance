...
from ...models.artefact_search_response import ArtefactSearchResponse
...
) -> ArtefactSearchResponse | HTTPValidationError | None:
    if response.status_code == 200:
        response_200 = ArtefactSearchResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ArtefactSearchResponse | HTTPValidationError]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        q (None | str | Unset): Search term for artefact names
...
def sync(
    *,
    ...
    Returns:
        ArtefactSearchResponse | HTTPValidationError
    """
