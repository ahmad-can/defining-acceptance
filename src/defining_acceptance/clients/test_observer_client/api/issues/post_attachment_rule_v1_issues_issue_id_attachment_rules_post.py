...
from ...models.issue_test_result_attachment_rule_post_request import (
...
def _get_kwargs(
    issue_id: int,
    *,
    body: IssueTestResultAttachmentRulePostRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/issues/{issue_id}/attachment-rules".format(
