...
T = TypeVar("T", bound="ArtefactBuildResponse")


@_attrs_define
class ArtefactBuildResponse:
    """
    Attributes:
        id (int):
        architecture (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for test_executions_item_data in _test_executions:
            test_executions_item = TestExecutionResponse.from_dict(
                test_executions_item_data
            )

            test_executions.append(test_executions_item)

        artefact_build_response = cls(
            id=id,
            architecture=architecture,
            revision=revision,
            test_executions=test_executions,
        ...
        artefact_build_response.additional_properties = d
        return artefact_build_response
